...
def load_and_align_data(high_dim_path, low_dim_path, labels_path, test_size=0.2, val_size = 0.1,random_state=42):
    ...
    merged_df = merged_df[(merged_df['Q2_label'] == 'AD') | (merged_df['Q2_label'] == 'MCI')]
    merged_df['Q2_label_01'] = merged_df['Q2_label_01'].replace(2, 0)
    ...
    labels = merged_df['Q2_label_01'].values
    ...
    # high_dim_features = scaler_high.fit_transform(high_dim_features_ori)
    # low_dim_features = scaler_low.fit_transform(low_dim_features_ori)
